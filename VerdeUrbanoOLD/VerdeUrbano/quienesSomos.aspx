<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/paginaMaestra.Master" CodeBehind="quienesSomos.aspx.vb" Inherits="VerdeUrbano.quienesSomos" %>
...
También contamos con una línea de productos que no requieren de nuestra intervención para ser instalados, simplemente siguiendo la guía instructiva podrán ser colocados. Esta capacitación será dada por cursos de E-Learing generados por nuestra propia compañía donde podrán aprender no solo sobre la instalación de alguno de nuestros productos, sino también sobre el mantenimiento de los jardines instalados por nuestra empresa. De esta forma, no solo nos desligaríamos de esta tarea, la cual ahorraremos tiempo y dinero, sino que también nuestros empleados podrán enfocarse en el diseño y creación de los jardines para ofrecer una mejor calidad de servicio."></asp:Label>
                        </p>
                    </div>
                </div>
            </div>
