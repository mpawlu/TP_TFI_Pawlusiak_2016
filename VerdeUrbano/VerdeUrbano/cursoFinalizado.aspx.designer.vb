...
Partial Public Class cursoFinalizado
    ...
    '''<summary>
    '''Control lbl_CursoFinalizado.
    '''</summary>
    '''<remarks>
    '''Campo generado automáticamente.
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents lbl_CursoFinalizado As Global.System.Web.UI.WebControls.Label
    ...
    '''Para modificarlo, mueva la declaración del campo del archivo del diseñador al archivo de código subyacente.
    '''</remarks>
    Protected WithEvents lbl_gracias As Global.System.Web.UI.WebControls.Label
End Class
