                                ...
                                <asp:TemplateField HeaderText="Acciones" HeaderStyle-Width="100px">
                                    <ItemTemplate>
                                        <div class="col-md-2 col-md-offset-1">
                                            <asp:ImageButton ID="btn_Bloqueo" runat="server" OnCommand="btn_Bloqueo_Command" ImageUrl="~/Imagenes/lock2-32.png" Height="20px" CommandArgument='<%#Eval("ID")%>' />
                                            <asp:ImageButton ID="btn_desBloqueo" runat="server" OnCommand="btn_desBloqueo_Command" ImageUrl="~/Imagenes/unlock2-32.png" Height="20px" CommandArgument='<%#Eval("ID")%>' />
                                        </div>
                                        <div class="col-md-2 col-md-offset-2">
                                            <asp:ImageButton ID="btn_Editar" runat="server" OnCommand="btn_Editar_Command" ImageUrl="~/Imagenes/edit-32.png" Height="20px" CommandArgument='<%#Eval("ID")%>' />
                                        </div>
                                        <div class="col-md-2 col-md-offset-2">
