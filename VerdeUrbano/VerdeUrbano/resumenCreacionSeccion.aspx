    ...
    <div class="row">
     ...
     <div class="row">
                            <div class="col-md-3 col-md-offset-1">
                                <asp:Label ID="lbltituloSeccion" runat="server" Text="Seccion:" CssClass="label"></asp:Label>
                            </div>
     </div>
      <div class="row">
                            <div class="col-md-3 col-md-offset-1">
                                <asp:Label ID="lbltitulo" runat="server" Text="Titulo de la seccion" CssClass="label"></asp:Label>
                            </div>
     </div>
     <br />
         <div class="row">
      ...
      <div class="row">
                            <div class="col-md-3 col-md-offset-1">
                                <asp:Label ID="lbldesc" runat="server" Text="Descripcion de la seccion" CssClass="label"></asp:Label>
                            </div>
     </div>
     <br />
     <div class="row">
                            <div class="col-md-3 col-md-offset-1">
                                <asp:Label ID="lblslides" runat="server" Text="Slides" CssClass="label"></asp:Label>
                            </div>
     </div>
    <br />
                            <div class="row">
                            <div class="col-md-10 col-md-offset-1">
                                <asp:GridView ID="gv_slides" runat="server" CssClass="Grid-verde" AutoGenerateColumns="False" HorizontalAlign="Center">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="Tipo" HeaderText="Detalle" HtmlEncode="False" ControlStyle-CssClass="col-md-4" />
                                    </Columns>
                                </asp:GridView>
                            </div>
                            <br />
